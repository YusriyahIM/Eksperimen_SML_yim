...
def preprocessing_pipeline(csv_path):
    ...
    def scaling(features, df, df_test):
        for feature in features:
            ...
            joblib.dump(scaler, f"D:\Learning\msml\Eksperimen_SML_yim\preprocessing\model\scaler_{feature}.joblib")
        return df, df_test
    ...
    def encoding(features, df, df_test):
        for feature in features:
            ...
            joblib.dump(encoder, f"D:\Learning\msml\Eksperimen_SML_yim\preprocessing\model\encoder_{feature}.joblib")
        return df, df_test
    ...
    joblib.dump(target_encoder, "D:\Learning\msml\Eksperimen_SML_yim\preprocessing\model\encoder_target.joblib")
    ...
    joblib.dump(pca_1, "D:\Learning\msml\Eksperimen_SML_yim\preprocessing\model\pca_1.joblib")
    ...
    joblib.dump(pca_2, "D:\Learning\msml\Eksperimen_SML_yim\preprocessing\model\pca_2.joblib")
...
file_path = 'D:\\Learning\\msml\\Eksperimen_SML_yim\\train_cleaned.csv'
